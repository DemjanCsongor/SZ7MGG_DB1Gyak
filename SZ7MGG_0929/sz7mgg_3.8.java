...
public class SZ7MGG_8 {

	private static SZ7MGG_8 adatok[];
	...
	public SZ7MGG_8(String aznosito, String nev) {
		this.aznosito = aznosito;
		this.nev = nev;
	}
	...
	public static SZ7MGG_8[] beker(SZ7MGG_8[] adatok, Scanner sc) throws IOException {
		...
		for (int i = 0; i < adatok.length; i++) {
			...
			adatok[i] = new SZ7MGG_8(azonosito, nev);
			ossz++;
	...
	public static void torles(SZ7MGG_8[] adatok, Scanner sc) throws IOException {
	...
	public static void modosit(SZ7MGG_8[] adatok, Scanner sc) throws IOException {
